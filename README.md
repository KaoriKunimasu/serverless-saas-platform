...
Two AWS-based services demonstrating different cloud application architecture and delivery approaches.
...
- Post-deployment HTTP health smoke test
...
5. Verify the deployed `/health` endpoint with an HTTP smoke test
...
cdk/       # AWS CDK infrastructu# Cloud Platform (AWS)
...
- Deployment, rollback, health verification, customer issue intake, and incident documentation are maintained alongside infrastructure and application code.
- Development resources can be stopped when not in use to reduce cloud costs.re for Project A
infra/     # Terraform infrastructure for Project B
docs/      # Architecture, runbooks, observability, and incident documentation
